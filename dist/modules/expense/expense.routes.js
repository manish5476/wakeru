...
// SETTLEMENT ROUTE
// ============================================================
router.patch('/:expenseId/splits/:userId/pay', (0, trip_middleware_1.validate)(expense_validation_1.markSplitPaidParamSchema, 'params'), expenseController.markSplitPaid);
