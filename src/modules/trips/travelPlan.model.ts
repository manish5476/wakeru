...
export interface IFlightDetail {
  ...
  date: Date; // Changed from string to Date
  time: string; // Kept as string (e.g. "14:30")
}

export interface IAccommodationDetail {
  hotelName: string;
  address: string;
  checkIn: Date; // Changed from string to Date
  checkOut: Date; // Changed from string to Date
    ...
    itinerary: [
      {
        ...
        location: { type: CoordinatesSchema, default: null }, // NEW: Map marker
    ...
    flightDetails: [
      {
        ...
        fromLocation: { type: CoordinatesSchema, default: null }, // NEW
        toLocation: { type: CoordinatesSchema, default: null },   // NEW
        date: { type: Date, default: null },
