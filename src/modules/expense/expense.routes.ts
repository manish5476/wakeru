...
router.get('/mine', validate(expenseListQuerySchema, 'query'), expenseController.getMyExpenses);
router.get('/stop/:stopId/summary', validate(stopExpenseParamSchema, 'params'), expenseController.getStopExpenseSummary);
router.get('/stop/:stopId', validate(stopExpenseParamSchema, 'params'), validate(expenseListQuerySchema, 'query'), expenseController.getStopExpenses);
router.get(
  '/trip/:tripId',
