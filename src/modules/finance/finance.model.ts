...
// Finance list: active (non-deleted) transactions sorted by date — used in every getTransactions call
transactionSchema.index({ userId: 1, isDeleted: 1, date: -1 });

// Finance list: filter by type AND deleted status together
transactionSchema.index({ userId: 1, isDeleted: 1, type: 1, date: -1 });

// Finance sync: find auto-generated transactions by expenseId
transactionSchema.index({ userId: 1, expenseId: 1, isAutoGenerated: 1 });

// Finance sync: find auto-generated settlement transactions
transactionSchema.index({ userId: 1, settlementId: 1, isAutoGenerated: 1 });
